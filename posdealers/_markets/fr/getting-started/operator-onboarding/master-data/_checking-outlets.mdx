...
![preview Edit Outlets](images/checking-outlets-23-02-07-FR.png "https://portal-sandbox.fiskaltrust.TLD/AccountOutlet")

*Figure 1. Outlets overview in the fiskaltrust.Portal; interface elements are listed in Table 1.*
...
*Table 1. Steps for checking and managing outlets shown in Figure 1.*
...
Each outlet needs its own SIRET, and the address must be entered before the SIRET is verified. See [SIREN and SIRET](#siren-and-siret) above for what the two numbers are, why they must be verified before a CashBox is configured, and what to do when the data check fails.
