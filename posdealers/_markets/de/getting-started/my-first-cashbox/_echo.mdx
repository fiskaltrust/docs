...
![Portal cashbox configuration page showing the Queue entry with its cloud Middleware URL highlighted](./media/cloudcashbox-url.png)

*Figure 1. Middleware URL on the CashBox configuration page in the fiskaltrust.Portal.*
