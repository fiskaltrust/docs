...
* the 'Carefree' column for the selected outlet under [`Company Name` / `Outlets`](https://portal-sandbox.fiskaltrust.de/AccountOutlet) shows a symbol for an active Carefree subscription.
