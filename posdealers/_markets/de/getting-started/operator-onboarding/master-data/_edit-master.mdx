...
*Figure 1. Master data edit view in the fiskaltrust.Portal.*
...
*Table 1. Steps for editing and checking master data.*
...
*Table 2. Meaning of the data check result symbols.*