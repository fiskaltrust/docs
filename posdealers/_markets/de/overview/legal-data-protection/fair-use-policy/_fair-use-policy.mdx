...
## Scope
This Fair Use Policy applies to the use of outlet-related products of _fiskaltrust_ gmbh.
...
In addition a maximum of 10,000 receipts per calendar month for outlet-based products may be requested in the affected outlet.
...
If a physical location cannot be covered by a single outlet due to higher requirements, you have the option to create additional virtual outlets for this physical location in the fiskaltrust.Portal. The virtual outlets must be created with the address of the physical location in the _fiskaltrust_ portal so that they can be assigned to it.  
...
[PDF Download of Fair Use Policy](media/market-de-fair-use-policy.pdf)
