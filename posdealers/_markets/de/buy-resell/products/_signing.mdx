...
It is possible to switch between vendors and types of TSEs as long as the appropriate products are purchased. You will find detailed instructions in the corresponding [KBA](https://portal.fiskaltrust.de/KBArticle#/KA-01112). 
...
We recommend using cloud TSEs in virtual environments, more information in this [KBA](https://portal.fiskaltrust.de/KBArticle#/KA-01080).
