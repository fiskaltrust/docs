...
*Figure 1. Onboarding email sent to the Operator to start the notifications data form.*

The onboarding email includes:

- A brief explanation of the notifications process
- A link to a **4-step data form** for the PosOperator to complete:
...
*Figure 2. Confirmation email with the ELSTER transmission protocol attached.*
...
*Table 1. Dealer and Operator responsibilities across the notification onboarding steps.*

![Notification Flow](./images/NotificationFlow_DE.png)

*Figure 3. Overview of the notification workflow between Dealer, Operator, and fiskaltrust.*
...
*Table 2. Master data values required in the POSOperator account for the notification.*
...
*Figure 4. Opening page of the operator form showing the steps to complete.*
...
*Figure 5. Company headquarters master data step of the operator form.*
...
*Table 3. Fields to complete for the company headquarters in the operator form.*

#### Tax Number
Example tax notice:  
![Steuernummer](./images/2_steuerbescheid_DE.jpg)

*Figure 6. Example tax notice showing where to find the tax number.*
...
*Figure 7. Review of existing branch location data, with missing or invalid entries marked in red.*
...
*Figure 10. Cash registers listed for a location, expanded via the > button.*

Missing information can be added using the **Edit** button.  
![POS Edit Window](./images/3_pos_Edit_windows_DE.png)

*Figure 11. Edit window for completing missing cash register information.*
...
*Table 4. Cash register fields available in the edit window.*
...
*Figure 12. All locations and cash registers marked green once data is complete.*
...
*Figure 13. Adding external cash registers not connected via the Middleware.*
...
*Figure 14. Choosing a DSFinV-K ZIP file to upload.*

The DSFinV-K is imported into the form by clicking **Import File**.  
![DSFinV-K Import](./images/4_dsfinvk_importr.png)

*Figure 15. Importing the uploaded DSFinV-K file into the form.*
...
*Figure 16. Selecting the location the DSFinV-K originates from before import.*
...
*Figure 17. Imported cash registers listed by location.*
...
*Figure 18. Manually adding a cash register.*
...
*Table 5. Fields for manually adding an external cash register.*
...
*Figure 19. Removing an incorrect location or cash register via the trash icon.*
...
*Figure 20. Completion overview listing all performed steps and any remaining errors.*
...
*Figure 21. Confirmation dialog on the accuracy and completeness of the data.*
...
*Table 6. Mapping of ELSTER form fields to DSFinV-K fields and where to find the data.*
