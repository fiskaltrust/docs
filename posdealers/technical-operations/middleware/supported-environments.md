...
|**CPU Architecture**                   | Multicore CPU recommended <br /> * x86 <br/> * x64 <br/> * ARM usable with restrictions - [more details here](../../../poscreators/middleware-doc/general/operation-modes/operation-modes.md#arm-processor) <br />The actual memory amount depends on the amount of receipts to process. |
