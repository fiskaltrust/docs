...
*Figure 1. Rollout Management tab with the Rollout products option in the fiskaltrust.Portal.*
...
*Figure 2. Selecting the Business Rollout option.*
...
*Figure 3. Searching for CloudCashbox products in the rollout wizard.*
...
*Figure 4. Selecting the operators for which the rollout is performed.*
...
*Figure 5. Selecting the outlets to be rolled out.*
...
*Figure 6. Reviewing the order before creating the quote.*
...
*Figure 7. Adding the selected products to the basket.*
...
*Figure 8. The Checkout Cart with the payment process.*
...
*Figure 9. Validating the order to generate the CloudCashbox.*
...
*Figure 10. The created CloudCashbox with its address and access token.*
...
*Figure 11. The created Queue under Configuration > Queue.*
...
*Figure 12. The Exchange product option under Rollout management.*
...
*Figure 13. Selecting Switch to CloudCashbox.*
...
*Figure 14. Selecting the PosOperator for the migration.*
...
*Figure 15. Selecting the outlet and queues to migrate.*
...
*Figure 16. Verifying the selection before requesting the migration.*
...
*Figure 17. Confirmation that the migration request has been sent.*
...
*Figure 18. Tracking the request status under Requests & Updates.*
...
*Figure 19. An approved migration request.*
...
*Figure 20. List of Queues and their migration status.*
...
*Figure 21. A Queue in the Ready to migrate column after the Start-Migration Receipt.*
...
*Figure 22. Selecting the queues that are ready to migrate.*


![20241017-12-migration-cloud-cashbox](https://github.com/user-attachments/assets/c34e40d8-176e-411f-8f44-8e850c3cf087)

*Figure 23. The technical migration of the selected queues in progress.*
...
*Figure 24. Returning to the request to migrate the remaining queues.*
