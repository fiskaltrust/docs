...
Spain has two fiscal frameworks: in the common territory every *Sistema Informático de Facturación* must comply with the VERI\*FACTU regulation (*Real Decreto 1007/2023*, *Orden HAC/1177/2024*), and the producer certifies this in a signed *declaración responsable*; in the Basque provinces of Araba, Bizkaia and Gipuzkoa the software is registered with a provincial tax authority under **TicketBAI**. The fiskaltrust.Middleware implements both: fiskaltrust has declared the fiskaltrust.Middleware towards the AEAT and has submitted its TicketBAI software registration. The [Declaration and Registration](./declaration/declaration.md) chapter describes what this covers, which document types are issued, where the identifiers appear on the document and where the boundaries of the implementation are. The [Receipt Printing](./receipt-printing/receipt-printing.md) chapter lists the mandatory elements of the printed or digital document.

PosCreators that use the fiskaltrust.Middleware enter the Spanish market under fiskaltrust's declaration and registration without a declaration or registration of their own. The [Go-to-Market](./go-to-market/go-to-market.md) chapter describes this path and summarises the key factors of the market.
