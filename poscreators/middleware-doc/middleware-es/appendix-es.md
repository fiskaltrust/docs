...
PosCreators that use the fiskaltrust.Middleware enter the Spanish market under fiskaltrust's declaration and registration and declare their POS as a component of the system. The [Go-to-Market](./go-to-market/go-to-market.md) chapter describes this path and summarises the key factors of the market.
