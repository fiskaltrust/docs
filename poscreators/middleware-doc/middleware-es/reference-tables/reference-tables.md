...
This page expands on the reference tables covered in the [Reference Tables](../../general/reference-tables/reference-tables.md) of the Compliance Middleware, with country-specific information applicable to the Spanish market. The respective tables can be found in the following subsections.
...
| **Value** | **Description** |
| --------- | --------------- |
| CCCC | (e.g 4553): ASCII of two letter ISO country code ([ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1)) (e.g. ES = 4553) |
...
*Table 1. Sections of the hex-based tagging format used for the Spanish market.*