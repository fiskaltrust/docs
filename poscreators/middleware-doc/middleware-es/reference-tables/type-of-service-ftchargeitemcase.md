...
| **Value** | **Description** |
| --------- | -------------- |
| `0` | **Unknown type of service for ES**<br />Not supported in Spain; charge items with this value are rejected (`EEEE_UnsupportedVatRate`). |
| `1` | **Discounted-1 VAT rate**<br />Reduced rate (*tipo reducido*), 10 %. |
| `2` | **Discounted 2 VAT rate**<br />Reduced rate, 10 % (same rate as `1`). |
| `3` | **Normal VAT rate**<br />General rate (*tipo general*), 21 %. |
| `4` | **Super reduced 1 VAT rate**<br />Super-reduced rate (*tipo superreducido*), 4 %. |
| `5` | **Super reduced 2 VAT rate**<br />Super-reduced rate, 4 % (same rate as `4`). |
| `6` | **Parking VAT rate**<br />Not supported in Spain; charge items with this value are rejected. |
| `7` | **Zero VAT rate**<br />0 %. The nature-of-VAT segment (`NN`) must identify the exemption or not-subject reason. |
| `8` | **Not Taxable**<br />0 %. The nature-of-VAT segment (`NN`) must identify the exemption or not-subject reason. |
...
| **Value** | **Description** |
| --------- | -------------- |
| `0` | **Unknown type of service**<br />Handled as delivery of goods. |
| `1` | **Delivery (supply of goods)** |
| `2` | **Other service (supply of service)** |
| `3` | **Tip**<br />Handled as a service. |
| `4` | **Voucher**<br />Not supported in Spain; rejected. |
| `5` | **Catalog service**<br />Handled as delivery of goods. |
| `6` | **Not own sales / Agency business**<br />Not supported in Spain; rejected. |
| `7` | **Own Consumption**<br />Not supported in Spain; rejected. |
| `8` | **Grant**<br />Not supported in Spain; rejected. |
| `9` | **Receivable**<br />Receivable creation is negative (-) amount<br />Receivable reduction is positive (+) amount.<br />Handled as a service. |
| `A` | **Cash Transfer**<br />Not supported in Spain; rejected. |
...
| **Value** | **Description** | **VERI\*FACTU record** | **TicketBAI file** |
| --------- | -------------- | ---------------------- | ------------------ |
| `00` | **Usual VAT applies** | `CalificacionOperacion` `S1`, `ClaveRegimen` `01` | *Sujeta/NoExenta*, `TipoNoExenta` `S1`, clave `01` |
| `10` | **Exempt: exports** (art. 21 LIVA) | `OperacionExenta` `E2`, `ClaveRegimen` `02` | *Sujeta/Exenta*, `CausaExencion` `E2`, clave `02` |
| `11` | **Exempt: intra-Community delivery of goods** (art. 25 LIVA) | `E5`, clave `01` | *Exenta* `E5`, clave `01` |
| `13` | **Exempt: transactions treated as exports** (art. 22 LIVA) | `E3`, clave `02` | *Exenta* `E3`, clave `02` |
| `14` | **Exempt: customs and tax-warehouse regimes** (art. 23 and 24 LIVA) | `E4`, clave `02` | *Exenta* `E4`, clave `02` |
| `20` | **Not subject: location rules** | `CalificacionOperacion` `N2`, clave `01` | *NoSujeta*, `Causa` `RL` |
| `21` | **Not subject: art. 7 and 14 LIVA and others** | `N1`, clave `01` | *NoSujeta*, `Causa` `OT` |
| `30` | **Exempt: domestic transactions** (art. 20 LIVA) | `E1`, clave `01` | *Exenta* `E1`, clave `01` |
| `31` | **Exempt: other exemptions** | `E6`, clave `01` | *Exenta* `E6`, clave `01` |
| `50` | **Reverse charge** (*inversión del sujeto pasivo*) | `CalificacionOperacion` `S2`, clave `01` | *Sujeta/NoExenta*, `TipoNoExenta` `S2`, clave `01` |
| `60` | **Not subject: foreign tax applies** (IPSI/IGIC territories or another country) | `N1`, clave `01`; the applied tax (`Impuesto`) follows the tax regime configured for the queue | *NoSujeta*, `Causa` `IE`, clave `08` |
| `80` | **Excluded: transactions on behalf of third parties** | `N1`, clave `01` | *NoSujeta*, `Causa` `VT`, clave `01` |
