...
This page expands on the reference tables covered in the [Reference Tables](../../general/reference-tables/reference-tables.md) of the Compliance Middleware, with country-specific information applicable to the Italian market. The respective tables can be found in the following subsections.
...
| **Value** | **Description** |
| --------- | --------------- |
| CCCC | (e.g 4954): ASCII of two letter ISO country code ([ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1)). (e.g. IT = 4954) |
