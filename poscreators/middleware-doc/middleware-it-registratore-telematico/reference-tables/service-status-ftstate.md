...
*Table 1. Global tagging/flag values of the ftState service status for the Italian market.*
...
*Table 2. Local flag values of the ftState service status for the Italian market.*
