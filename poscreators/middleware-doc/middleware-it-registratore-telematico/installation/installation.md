...
This chapter expands on the installation documentation covered in [Installing and Configuring Components](../../general/components/components-install-config.md) in General part, with country-specific information applicable to the Italian market. 
