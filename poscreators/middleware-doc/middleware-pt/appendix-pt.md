...
PosCreators can enter the Portuguese market either under this certificate or by certifying their own solution built on the fiskaltrust.Middleware. The [Go-to-Market](./go-to-market/go-to-market.md) chapter compares the two routes. The Certification chapter describes the first route; for the second route fiskaltrust is looking for a first partner (contact [sales@fiskaltrust.pt](mailto:sales@fiskaltrust.pt)).
