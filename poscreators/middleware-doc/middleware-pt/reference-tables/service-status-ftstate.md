...
*Table 1. Global ftState flags for the Portuguese market, with the Middleware version that introduced each.*
...
*Table 2. Local ftState flags for the Portuguese market (to be defined).*
