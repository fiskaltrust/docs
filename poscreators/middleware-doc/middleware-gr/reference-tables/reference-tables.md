...
This page expands on the reference tables covered in the [Reference Tables](../../general/reference-tables/reference-tables.md) of the Compliance Middleware, with country-specific information applicable to the Greek market. The respective tables can be found in the following subsections.
...
*Table 1. Sections of the tagging format for Greece.*
