...
This chapter expands on the reference tables covered in [Reference Tables in General Part](../../general/reference-tables/reference-tables-v1.md#reference-tables), with country-specific information applicable to the Greek market. The respective tables can be found in the following sub-sections.
