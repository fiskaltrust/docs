...
| `ftSignatures`          | `SignatureItem[]`         | []                | false       | List of signature items generated by **fiskaltrust.Middleware**. This must be printed on the receipt according to given format instructions to comply with national regulations/law and to enable **fiskaltrust's** Compliance-as-a-Service. See [SignatureItem](#signatureitem). |
