...
All configuration settings are managed centrally via the fiskaltrust.Portal, where Queues, journals, notifications, and market-specific parameters are defined and maintained.

This section describes the core configuration components and provides references to country-specific configuration scenarios for Austria, Germany, France, and Italy.
