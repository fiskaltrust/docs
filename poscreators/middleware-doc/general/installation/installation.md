...
*The availability depends on the CashBox configuration. For more details, see the [platform documentation for Android](../../middleware-de-kassensichv/operation-modes/on-premise-platforms/android.md).
...
The fiskaltrust.Middleware for Android is currently available for the German market only. For details about the platform specific installation, please refer to the [platform documentation for Android](../../middleware-de-kassensichv/operation-modes/on-premise-platforms/android.md).
