...
| fiskaltrust.Helipad           | API for configuration purposes and data upload, accessible on [Helipad](https://helipad.fiskaltrust.cloud).                                                                                                                                                         |
| fiskaltrust.Packages          | API for versioned and packaged components, accessible on [Packages](https://packages.fiskaltrust.cloud).                                                                                                                                                             |
