...
A list with various possibilities for the request parameter ftJournalType is included in the reference table ["Type of Journal: ftJournalType"](../../general/reference-tables/reference-tables-v2.md#ftjournaltype).
