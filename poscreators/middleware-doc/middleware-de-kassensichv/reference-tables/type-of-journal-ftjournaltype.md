...
This table expands on the values provided in table of Chapter ["Type of Journal: ftJournalType"](../../general/reference-tables/reference-tables-v2.md#ftjournaltype) of the General part with values applicable to the German market.
