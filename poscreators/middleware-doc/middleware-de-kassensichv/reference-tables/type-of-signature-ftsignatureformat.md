...
The Middleware uses the same ftSignatureFormat in Germany as in all other countries, as described in the table [Format of Signature: ftSignatureFormat](../../general/reference-tables/reference-tables.md#format-of-signature-ftsignatureformat) of the Compliance Middleware.
