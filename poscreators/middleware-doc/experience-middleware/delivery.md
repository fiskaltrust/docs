...
#### eInvoice Payload Examples

The following examples show eInvoice requests for different transaction types.
...
3. Depending on the customer's selection and the merchant's configuration, the POS triggers one or more delivery options:
   ...
   - Submit an eInvoice through the relevant national or European channel (where supported).
...
- **Business customers** can request a structured invoice or eInvoice for direct import into their accounting system.
...
By consolidating these formats under a single delivery layer, the Experience Middleware supports both current paper and digital receipt scenarios and future structured invoice and eInvoicing requirements through one coherent integration.

### eDelivery

eDelivery refers to having a defined digital channel for communicating and exchanging documents such as invoices and receipts. Common channels include email — a widely adopted digital protocol — or regulated networks such as **Peppol**, mandated in several countries for B2B and B2G document exchange.
