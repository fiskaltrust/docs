...
*Table 1. Structure of the ftReceiptCase format sections.*
...
| `8000` | **ReceiptRequest**<br />If you don’t receive a response, try this flag first before taking any other action.<br />This will return a stored result for example in case of a timeout when the cash register calls the fiskaltrust.Middleware. | 1.3.45 |

*Table 4. ftReceiptCase global tagging/flag values for the Belgian market.*
...
*Table 5. ftReceiptCase local tagging/flag values for the Belgian market (to be defined).*
