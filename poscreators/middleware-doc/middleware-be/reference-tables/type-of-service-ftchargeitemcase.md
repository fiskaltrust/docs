...
This table expands on the values provided in the table [ftChargeItemCase in General Part](../../general/reference-tables/reference-tables-v1.md#type-of-service-ftchargeitemcase), with country-specific values applicable to the Belgian market.
