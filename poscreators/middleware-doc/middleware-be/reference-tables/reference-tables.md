...
| **Value** | **Description** |
| --------- | ----------------|
| CCCC | (e.g 4245): ASCII of two letter ISO country code ([ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1)) (e.g. BE = 4245) |
...
*Table 1. Structure of the four sections that make up the Belgian tagging format.*
