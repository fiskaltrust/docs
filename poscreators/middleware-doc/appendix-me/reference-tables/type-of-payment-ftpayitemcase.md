...
This table expands on the values provided in table [ftPayItemCase in General Part](../../general/reference-tables/reference-tables-v1.md#type-of-payment-ftpayitemcase) with values applicable to the Montenegrin market.
